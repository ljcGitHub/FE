...
* [6. 简单的电商项目](https://github.com/ljcGitHub/koa2-server/tree/master/example/six/1)
  * [6.1 数据库表](https://github.com/ljcGitHub/koa2-server/tree/master/example/four/1)
  * [6.2 Vue环境搭建](https://github.com/ljcGitHub/koa2-server/tree/master/example/four/1)
* [6. PM2管理进程]()
* [7. 错误处理与日志上报]()
* [8. 服务器部署]()
* [9. nginx配置]()
